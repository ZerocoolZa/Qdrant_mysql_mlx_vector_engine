...
INSERT INTO patterns 
    (pattern, action, category, severity, confidence, source, description, pattern_type)
    VALUES ('rm', 'block', 'ss64-scraped', 5, 0.8, 'ss64-scrape', 'Remove files/directories', 'literal');
INSERT INTO patterns 
    (pattern, action, category, severity, confidence, source, description, pattern_type)
    VALUES ('rmdir', 'block', 'ss64-scraped', 5, 0.8, 'ss64-scrape', 'Remove directories', 'literal');
INSERT INTO patterns 
    (pattern, action, category, severity, confidence, source, description, pattern_type)
