//[@GHOST]{file_path="Cascade_toolStack/vbast/vbstyle_check.c" date="2026-06-29" author="Devin" session_id="vbast-bcl-stamp" context="11 VBStyle compliance checks using real AST data"}
//[@VBSTYLE]{standard="VBStyle" version="1" rules="PascalCase UPPERCASE Tuple3 Run dispatch self.state no-self._ no-print"}
//[@FILEID]{id="vbstyle_check.c" domain="vbast" authority="VbstyleChecker"}
//[@SUMMARY]{summary="VBStyle checker — 11 compliance checks using AST-extracted data"}
//[@CLASS]{class="VbstyleChecker" domain="vbast" authority="single"}
//[@METHOD]{methods="check_vbstyle,check_print_violations,check_pass_count,check_fail_count"}
//
