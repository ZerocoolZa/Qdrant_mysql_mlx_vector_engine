/*
 * msearch2.c v5 — Brain-Connected Schema-Aware MySQL + Qdrant Vector Search CLI
 *
 * v5 NEW: --smart Consolidated Semantic Object (10 sections, 1 query)
...
static void usage(const char *p) {
    fprintf(stderr,
        "msearch2 v5 — Brain-Connected MySQL + Qdrant Vector Search\n"
        "\n"
