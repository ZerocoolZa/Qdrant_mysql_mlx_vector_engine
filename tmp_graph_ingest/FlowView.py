# [@GHOST]
# Ghost header — FlowView
# Purpose: How does it move? — thin wrapper around GraphEngine.flow view
# [@VBSTYLE]
...
class FlowView:
    ...
    def GetData(self, params):
        ...
        return self.state["engine"].Run("flow", params)
