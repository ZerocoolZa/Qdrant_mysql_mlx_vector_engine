# [@GHOST]
# Ghost header — GapView
# Purpose: What is missing? — thin wrapper around GraphEngine.gap view
# [@VBSTYLE]
...
class GapView:
    ...
    def GetData(self, params):
        ...
        return self.state["engine"].Run("gap", params)
