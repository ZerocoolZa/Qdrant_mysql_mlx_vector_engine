# [@GHOST]
# Ghost header — PlanView
# Purpose: What are we building? — thin wrapper around GraphEngine.plan view
# [@VBSTYLE]
...
class PlanView:
    """Graph view: What are we building?"""
    ...
    def GetData(self, params):
        ...
        return self.state["engine"].Run("plan", params)
