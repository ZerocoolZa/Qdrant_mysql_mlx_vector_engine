# [@GHOST]
# Ghost header — DependencyView
# Purpose: Why does it connect? — thin wrapper around GraphEngine.dependency view
# [@VBSTYLE]
...
class DependencyView:
    """Graph view: Why does it connect?"""
    ...
    def GetData(self, params):
        ...
        return self.state["engine"].Run("dependency", params)
