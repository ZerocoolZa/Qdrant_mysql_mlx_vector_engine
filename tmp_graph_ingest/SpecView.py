# [@GHOST]
# Ghost header — SpecView
# Purpose: What exactly exists? — thin wrapper around GraphEngine.spec view
# [@VBSTYLE]
...
class SpecView:
    """Graph view: What exactly exists?"""
    ...
    def GetData(self, params):
        ...
        return self.state["engine"].Run("spec", params)
