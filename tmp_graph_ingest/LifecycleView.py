# [@GHOST]
# Ghost header — LifecycleView
# Purpose: When does it run? — thin wrapper around GraphEngine.lifecycle view
# [@VBSTYLE]
...
class LifecycleView:
    ...
    def GetData(self, params):
        ...
        return self.state["engine"].Run("lifecycle", params)
